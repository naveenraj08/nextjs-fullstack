...
const UserResgistration = () => {
    ...
    const createUser = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!validatedUser.success) {
            setLoading(false);
            validatedUser.error.errors.forEach((err) => {
                if (err.path[0] === "email") {
                ...
                <form className="mt-8" onSubmit={createUser}>
                        ...
                        <div className="block w-full">
                            <div className="grid gap-2">
                                <Input
                                    id="email"
                                    type="email"
                                    className={`${emailError ? 'border-red-600' : 'border-input'} py-2.5 h-12 placeholder:text-[13px]`}
                                    name="email"
                        ...
                        <div className="block w-full">
                            <div className="grid gap-2 relative">
                                <Input
                                    id="password"
                                    name="password"
                                    className={`${passwordError ? 'border-red-600' : 'border-input'} py-2.5 h-12 pr-14 placeholder:text-[13px]`}
                    ...
                    <div className="mt-6">
                        <Button
                            type="submit"
                            disabled={loading}
                            className="relative rounded-lg cursor-pointer w-full h-12 px-10 py-2 text-sm font-semibold"
                        >
                            <span
